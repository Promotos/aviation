# Generated by Django 4.2.5 on 2024-11-10 16:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_url', models.CharField(blank=True, help_text='Bild von dem Flugzeug.', max_length=100)),
                ('description', models.TextField(blank=True, help_text='Beschreibung des Flugzeugs.', max_length=500)),
            ],
        ),
        migrations.CreateModel(
            name='Checklist',
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Beschreibung der Checkliste.', max_length=500)),
                ('airplane', models.ForeignKey(help_text='Für welches Flugzeug diese Checkliste gilt.', on_delete=django.db.models.deletion.CASCADE, to='checklist.airplane')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homepage', models.CharField(blank=True, help_text='Webseite des Vereins.', max_length=100)),
                ('contact', models.CharField(blank=True, help_text='Webseite des Vereins.', max_length=100)),
                ('description', models.TextField(blank=True, help_text='Beschreibung des Vereins.', max_length=500)),
